  ...
  return (
    <section className="card">
      ...
      <div className="form-section">
        ...
        <NumberField label="目前可投資資產" value={params.current_base} min={0} max={500_000_000} step={100_000} unit="元" onChange={(current_base) => onChange({ current_base })} />
        <NumberField label="每月儲蓄 / 投入" value={params.monthly_saving} min={0} max={1_000_000} step={5_000} unit="元" onChange={(monthly_saving) => onChange({ monthly_saving })} />
      </div>
